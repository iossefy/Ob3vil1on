...
class Ui_ObevilionGUI(object):
    def setupUi(self, ObevilionGUI):
        ...
        self.inputText = QtGui.QPlainTextEdit(ObevilionGUI)
        self.inputText.setGeometry(QtCore.QRect(170, 10, 271, 31))
        ...
        self.Choose.setGeometry(QtCore.QRect(460, 10, 161, 32))
